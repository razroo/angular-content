...
\mybox{It is important to note, that any animatable property that can be 
animated using CSS transitions, can be animated using Angular.}

\subsection{Automatic property calculation with wildcards}
