...
Angular's internal framework uses the BCP47 norm. It's very important
...
Angular by default will use \lstinline{en-us}. Therefore the default locale is
American English. 
...
letter n". I thought I'd share a little bit of the interesting history behind 
\lstinline{i18n}. 
...
\footnote{http://www.i18nguy.com/origini18n.html}
}

(Graphic goes here for internationalization)

There is no actual pipe actually called the "i18n" pipe. However, these four 
pipes: 
\begin{enumerate}
...
\mybox{In truth, I prefer AOT because it is much more straightforward. I was debating 
...
recommended architecture, is that your app uses \lstinline{AOT} exclusively 
from the beginning.}
