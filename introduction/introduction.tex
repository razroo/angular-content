...
I had to learn all of this for the first time too, so I am extremely empathetic towards explaining things in a concise and clear manner. In addition, Angular is a ginormous ecosystem. Between all the nuances with RxJS, Angular it's self, \lstinline{@ngrx/store} it is so easy to forgot without constant repitition. I therefore tried to find the happy medium between the three potential scenarios:
\begin{enumerate}
  \item Expert, looking to organize thoughts on architecture, and learn prior unknowns.
  \item Expert who needs to refresh due to time elapsed. 
  \item First time learner.
\end{enumerate}
...
\begin{enumerate}
  ...
  \item item two
\end{enumerate}
We at Razroo feel it is much easer to think in numbers, versus having to quantify for one's self the content in a paragraph.
