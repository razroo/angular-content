...
seting of Angular, these are used within" 
\begin{enumerate}
...
based on resepctive non-contrast color map
}

\section{Material Design and Sass}
In Angular, Sass tends to be the de-facto CSS pre-processor that is used across
mutliple libraries in Angular. Material Design unexpectedly offers Sass 
functionality out of the box, and makes it incredibly easy to customize your
environment based on sass overrrides. Let's install Angular Material, so that
