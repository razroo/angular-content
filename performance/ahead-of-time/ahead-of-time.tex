...
\mybox{It should be noted that in this book we reccomend the use of Nrwl Nx. 
Nrwl Nx when creating a library, will by default add the 
\lstinline{"strictMetadataEmit": true}}
