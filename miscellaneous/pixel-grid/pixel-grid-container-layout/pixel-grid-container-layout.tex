...
\chapter{ Pixel Grid Container Layout }
...
\section{ Anticipate for Future Components }
...
\section{ Adding FxLayout to Pixel Grid Page }

\subsection{ Add Flex Layout to App }
\begin{verbatim}
  npm i --save @angular/flex-layout
\end{verbatim}

\subsection{ Add Flex Layout to Pixel Grid Page Module }
\begin{lstlisting}
