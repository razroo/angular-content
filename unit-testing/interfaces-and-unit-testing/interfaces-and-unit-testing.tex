...
\chapter{ Interfaces and Unit Testing }
...
\section{ In Sync Data - Interface Architecture }
...
\subsection{ Interface Architecture - The Dillema }
...
\section{ In Sync Data - The Solution }
...
\section{ Data Access - Folder Structure }
...
\section{ Example of How Interface Might Be Used in Real Time }
...
\section{ Example of How Data Mock Will Look Like }
...
\subsection{ Service for Pulling in Pre-Populated Grid Form }
...
\subsection{ Service Spec for Pulling in Pre-Populated Grid Form }
...
\subsection{ Reducer for populating state with appropriate Grid }
...
\subsection{ Reducer Spec for populating state with appropriate Grid }
\begin{lstlisting}
...
\subsection{ Effect for populating state with appropriate Grid }
\begin{lstlisting}
@Effect()
...
\subsection{ Effect Spec for populating state with appropriate Grid }
\begin{lstlisting}
const projectId = '123';
