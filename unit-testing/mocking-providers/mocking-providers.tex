...
within our component for our unit test, is using the above data. This gives us
more control over what we want to do. We can make the data more complex, to test
different use cases per it block that we want to use.
...
to skip this chapter, is because there are many teams working in fortune 500
companies that are confused as to how to properly mock services, and when it
might be appropriate to do so. This chapter properly informs a software engineer
when that situation might be appropriate.
}
