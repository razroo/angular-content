...
\section{ The Benefits of Jest Vs. Karma }
\begin{enumerate}
  \item Fast and sandboxed
  \item Built-in code coverage reports
\end{enumerate}

\subsection{ Fast and sandboxed }
...
\subsection{ Built-in code coverage reports }
...
\subsection{ Does not require starting a Browser }
...
\section{ Using Jest within an Nx Setting }
\begin{verbatim}
  ng generate jest
\end{verbatim}
