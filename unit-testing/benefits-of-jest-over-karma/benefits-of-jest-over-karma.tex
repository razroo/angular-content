...
\chapter{ Benefits of Jest Over Karma  }
...
be difficult to convert tests from karma over to Jest. For 3000 tests,
...
move over to karma, after writing for a month, and being used for the tests.
