...
structured to recognize relations among stored items of information) is to
eliminate data redundancy, and anomolies with regards to Insertion, Delete, and
updating. Within a front end setting, it is mostly the backend that deals with
a large portion of eliminating data redudancy, and CRUD anomolies. However,
...
two reasons.
\begin{enumerate}
  \item It is a library based on comp sci fundementals of building a relational
  databases.
