...
\chapter{ The Case for Using Ngrx/Entity by Default}

\section{ A Synopsis of Normalization}
...
\section{Why Ngrx/entity is Exciting}
...
\section{Dis-secting a Real World Example of ngrx/entity}

\subsection{CodeBox Interface}
