...
GithubProjects.}. Create a directory called 'angularPixelIllustrator', which will
be the directory for our app.
(What you should have done)
\begin{verbatim}
  mkdir angularPixelIllustrator;
  cd angularPixelIllustrator;
\end{verbatim}

Now inside of your angularPixelIllustrator, run the following command:
\begin{verbatim}
  create-nx-workspace
\end{verbatim}

The following files/folders will not be created in our angularPixelIllustrator
app:
\begin{verbatim}
apps/
libs/
...
\subsection{Nrwl nx notable mentions}
